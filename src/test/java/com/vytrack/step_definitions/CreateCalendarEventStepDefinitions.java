...
public class CreateCalendarEventStepDefinitions {
    ...
    public void user_click_on_save_and_close_button() {
        System.out.println("User clicks on save and close");
    ...
    public void user_verifies_that_description_of_new_calendar_event_is(String string) { //parameter in here is expected result that is coming from feature file ALWAYS
        Assert.assertEquals(string, calendarEventsPage.getGeneralInfoDescriptionText()); //actual result comes from PAGE
    }
